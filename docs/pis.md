...
- `X-BicFi` the BICFI for the user's ASPSP. Find it in [the ASPSP API](/docs/en/openpayments-NextGenPSD2-1.3.3.html#tag/ASPSP-Information-Service-(ASPSPIS)).
...
The [Get ASPSP Details endpoint](/docs/en/openpayments-NextGenPSD2-1.3.3.html#operation/getASPSPDetails) will tell you what payment products that are availalbe for that ASPSP.
