...
The [Get ASPSP Details endpoint](/en/openpayments-NextGenPSD2-1.3.3.html#operation/getASPSPDetails) will tell you what payment products that are available for that ASPSP.
